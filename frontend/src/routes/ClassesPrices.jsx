    ...
    <>
      <div className=" py-20 w-full bg-sky-100">
        <div className="flex flex-col justify-center items-center">
          <h2 className="font-semibold text-3xl mb-10 underline">
            Dartford Dojo
          </h2>
          <div className="flex flex-col md:flex-row gap-10 mx-5 items-center md:items-stretch">
            ...
            <div className="bg-white rounded-2xl w-4/5 md:w-1/2 shadow-xl flex flex-col items-center justify-center">
